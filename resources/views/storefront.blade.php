...
<main class="page">
    ...
    <div class="layout">
        ...
        <aside><section id="auth-section" class="section auth-card"><div><h2>登录或注册</h2><p class="subtle">登录后即可购买套餐并查看订单。</p></div><form id="auth-form"><label>邮箱<input name="email" type="email" placeholder="name@example.com" autocomplete="email" required></label><label>密码<input name="password" type="password" minlength="8" placeholder="至少 8 位" autocomplete="current-password" required></label><div style="display:flex;gap:8px"><button type="submit">登录</button><button type="button" id="register" class="secondary">注册</button></div></form><div class="divider"></div><p class="subtle" style="margin:0;font-size:12px">客户账号与主站账号通用。</p></section></aside>
    </div>
</main>
