...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'reward_dice_bet_gb' => 'integer|min:1|max:10',
        'reward_dice_odds' => 'integer|min:1|max:10',
        'reward_dice_win_face' => 'integer|min:1|max:6',
        'reward_slots_daily_limit' => 'integer|min:0|max:100',
        'reward_slots_bet_gb' => 'integer|min:1|max:10',
        'reward_slots_odds' => 'integer|min:1|max:10',
        'reward_slots_jackpot_rate' => 'integer|min:1|max:10000',
        'reward_poker_daily_limit' => 'integer|min:0|max:100',
        'reward_poker_bet_gb' => 'integer|min:1|max:10',
        'reward_poker_odds' => 'integer|min:1|max:10',
