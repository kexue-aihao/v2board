...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'site_status' => 'in:normal,maintenance,shutdown',
        'site_status_title' => 'nullable|string|max:80',
        'site_status_message' => 'nullable|string|max:500',
        'site_status_recovery_at' => 'nullable|integer|min:0',
        'app_name' => '',
        'app_description' => '',
        ...
        'multi_subscription_enable' => 'in:0,1',
        ...
        'reward_dice_daily_limit' => 'integer|min:0|max:100',
        'reward_dice_enable' => 'in:0,1',
        'reward_dice_win_probability' => 'integer|min:0|max:100',
        'reward_dice_payout_multiplier' => 'numeric|min:1|max:1000',
        'reward_dice_odds' => 'integer|min:0|max:100',
        'reward_dice_win_face' => 'integer|min:1|max:6',
        'reward_slots_daily_limit' => 'integer|min:0|max:100',
        'reward_slots_enable' => 'in:0,1',
        'reward_slots_win_probability' => 'integer|min:0|max:100',
        ...
        'reward_poker_win_probability' => 'integer|min:0|max:100',
        ...
        'oauth_google_redirect_uri' => 'nullable|url',
        'oauth_github_enable' => 'in:0,1',
        'oauth_github_client_id' => 'nullable|string|max:255',
        'oauth_github_client_secret' => 'nullable|string|max:255',
        'oauth_github_redirect_uri' => 'nullable|url',
        'oauth_telegram_enable' => 'in:0,1',
        'oauth_telegram_login_domain' => 'nullable|string|max:255',
        'oauth_telegram_bot_username' => 'nullable|string|max:64',
        'recaptcha_key' => '',
        'recaptcha_site_key' => '',
        'email_verify' => 'in:0,1',
